# decrypt by Raziqullah saadat
# Decompiled from: Python 2.7.18 (default, April  15 2023, 22:52:25) 
...
try:
    ...
    time.sleep(1)
    os.system('Then type: python Saadat.py')
...
print 25 * '\x1b[1;96m-'
CorrectUsername = 'Raziq'
CorrectPasscode = 'Saadat'
loop = 'true'
while loop == 'true':
